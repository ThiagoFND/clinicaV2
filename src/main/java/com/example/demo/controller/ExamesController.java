...
import com.example.demo.service.ExamesService;
...
public class ExamesController {
	...
	public ExamesDTO create(@RequestBody ExamesDTO exames) {
		return examesService.create(exames);
	}
	...
	@PutMapping(value = "/{id}",
            consumes = MediaType.APPLICATION_JSON_VALUE,
            produces = MediaType.APPLICATION_JSON_VALUE)
	public ExamesDTO update(@PathVariable Long id, @RequestBody ExamesDTO exames) {
		...
		ExamesDTO updatedExame = examesService.update(exames);
		return updatedExame;
	}
